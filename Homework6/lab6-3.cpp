...
static uint16_t PCM_Buffer[PCM_BUFFER_LEN];
static BSP_AUDIO_Init_t MicParams;

static DigitalOut led(LED1);
static DigitalOut PIN1(D7);
static DigitalOut PIN2(D8);
...
void start_recording() {
    ...
    ret = BSP_AUDIO_IN_Record(AUDIO_INSTANCE, (uint8_t *) PCM_Buffer, PCM_BUFFER_LEN * 2);
    if (ret != BSP_ERROR_NONE) {
