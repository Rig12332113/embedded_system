...
// const uint32_t SAMPLE_BUFFER_SIZE = 256;
...
void HAL_ADC_Get_Half_Value() 
{
    printf("HAL_ADC_ConvHalfCplt Values:\n");
...
void HAL_ADC_Get_Rest_Value() 
{
    printf("HAL_ADC_ConvCplt Values:\n");
...
{
    event_queue.call(HAL_ADC_Get_Rest_Value);
	// printf("complete");
...
{
    event_queue.call(HAL_ADC_Get_Half_Value);
    // printf("halfcomplete");	
}
